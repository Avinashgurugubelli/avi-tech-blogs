# Number Systems and Data Representation Guide
...
6. [The Problem in Real-World Systems](#-the-problem-in-real-world-systems)
    - [Why Not Use Plain Text or JSON?](#why-not-use-plain-text-or-json)
7. [The Need for Efficient Encoding](#the-need-for-efficient-encoding)
