...
3. [Hexadecimal System (Base 16)](#hexadecimal-system-base-16)
4. [Data Storage Units](#4-data-storage-units)
5. [Data Representation](#5-data-representation)
6. [Formats for Encoding Data](#formats-for-encoding-data)
7. [The Problem in Real-World Systems](#-the-problem-in-real-world-systems)
    - [Why Not Use Plain Text or JSON?](#why-not-use-plain-text-or-json)
8. [The Need for Efficient Encoding](#the-need-for-efficient-encoding)
    - [Message PACK format](#1-message-pack-format)
    - [Size Comparison](#size-comparison)
    - [Encode a JSON object using MessagePack in Node JS](#encode-a-json-object-using-messagepack-in-node-js)
    - [Thrift and Protocol Buffers](#2-thrift-and-protocol-buffers)
